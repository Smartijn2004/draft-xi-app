...
const OPP_SQUADS: Record<string, string[]> = {
  ...
  'Arsenal': ['Saka', 'Ødegaard', 'Gyökeres', 'Martinelli', 'Trossard', 'Merino'],
  ...
  'Everton': ['Ndiaye', 'Beto', 'McNeil', 'Calvert-Lewin', 'Branthwaite'],
  'Fulham': ['Jiménez', 'Iwobi', 'Muniz', 'Smith Rowe', 'King'],
  'Brentford': ['Igor Thiago', 'Schade', 'Yarmoliuk', 'Damsgaard', 'Janelt'],
  'Crystal Palace': ['Mateta', 'Sarr', 'Muñoz', 'Eze', 'Kamada'],
