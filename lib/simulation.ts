...
export const WC2026_NATIONS = [
  ...
  { name: 'Japan', rating: 84 }, { name: 'Morocco', rating: 84 }, { name: 'Czechia', rating: 84 }, { name: 'Saudi Arabia', rating: 84 },
  ...
  { name: 'Ecuador', rating: 83 }, { name: 'Mexico', rating: 82 }, { name: 'Qatar', rating: 82 }, { name: 'Egypt', rating: 82 },
  { name: 'South Africa', rating: 82 }, { name: 'Ghana', rating: 82 }, { name: 'Paraguay', rating: 81 }, { name: 'Congo DR', rating: 81 },
  { name: 'Australia', rating: 81 }, { name: 'Curaçao', rating: 81 }, { name: 'Bosnia And Herzegovina', rating: 80 }, { name: 'Haiti', rating: 80 },
