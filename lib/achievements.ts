...
const DEFS: Def[] = [
  ...
  { id: 'perfect', name: 'Immortal', emoji: '👑', category: 'Performance',
    description: 'The holy grail — sweep every match of a knockout, or win 34+ of a league season with zero defeats.',
    check: c => (c.format === 'tournament' && c.isPerfect) || (c.format === 'league' && c.lost === 0 && c.won >= 34) },
